...
public class GetPokemonDataResponse {
    String id;
    String name;
    PokemonType type;
    int height;
    ...
    public GetPokemonDataResponse(String id, String name, PokemonType type, int height, int weight, List<Ability> abilities) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.height = height;
    ...
    public GetPokemonDataResponse(String message) {
